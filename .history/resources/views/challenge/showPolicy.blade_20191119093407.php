	...
	@if (isset($model))
		<div class="box-header with-border">
			<div class="row">
				...
				<form style="margin-right: 30px" class="link" onclick="return confirm('Are you sure?')" action="{{ route('challenges.deletePolicy', $model->id)}}" method="post">
					@csrf
					@method('DELETE')
					<button class="btn btn-danger pull-ringt" data-toggle="tooltip" data-original-title="Xóa" type="submit">

	...
	@if (isset($model))
		<div class="box-header with-border">
			...
			@include('inc.error')
				...
				<form class="link delete" action="{{ route('challenges.deletePolicy', $model->id)}}" method="post">
					@csrf
					@method('DELETE')
					<button style="align-items: center" class="btn btn-danger" data-toggle="tooltip" data-original-title="Xóa" type="submit">
						<span>Delete</span>
					</button>
				</form>
		</div>

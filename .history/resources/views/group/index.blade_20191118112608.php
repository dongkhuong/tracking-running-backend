	...
	<div class="box-header">
		...
		<div class="box-tools">
			<div class="pull-right">
				<a class="btn btn-info mb-2" href="{{ route('groups.create') }}">Create Group</a>
			</div>
		</div>
	</div>
	<!-- /.box-header -->
			...
			<table class="table table-striped table-bordered table-search" action="{{ route('groups.index') }}">
				<thead>
					<tr>
						...
						<th><a href="#" data-sort="image">Challenges</a></th>
					...
					@foreach($items as $i => $item)
						<tr>
							...
							<td class="text-center">
								<a href="{{ route('challenges.index', $item->id)}}" title="Cập nhật" data-toggle="tooltip" data-original-title="Cập nhật">

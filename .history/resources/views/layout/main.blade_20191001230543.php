                            ...
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="{{ route('feedbacks.index') }}">
                            			<i class="fa fa-comments-o"></i> Gởi phản hồi
                            		</a>
                                </li>
                                <li>
                                    <a href="{{ route('profiles.index') }}">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="/hours">
                        <i class="fa fa-clock-o"></i> <span>Khung giờ</span>
                ...
                <li>
                    <a href="/articles">
                        <i class="fa fa-map"></i> <span>Bài viết</span>
                        <span class="pull-right-container">
                ...
                <li>
                    <a href="/drivers">
                        <i class="fa fa-user-secret"></i> <span>Tài xế</span>
                        <span class="pull-right-container">
        ...
        @if(AuthAssignment::hasSupperAdmin())
            <li> 
                <a href="/term">
                    <i class="fa fa-map"></i> <span>Terms and Conditions</span>
                    <span class="pull-right-container">
            ...
            <li>
                <a href="/policy">
                    <i class="fa fa-map"></i> <span>Policy</span>
                    <span class="pull-right-container">
                    <small class="label pull-right bg-green"></small>
                    </span>
                </a>
        ...
        <li>
          <a href="/settings">
            <i class="fa fa-gear"></i> <span>Cài đặt</span>
                ...
                <li>
                    <a href="/cars">
                        <i class="fa fa-car"></i> <span>Xe</span>
                        <span class="pull-right-container">
                ...
                <li>
                    <a href="/car-types">
                        <i class="fa fa-bus"></i> <span>Loại Xe</span>
                        <span class="pull-right-container">
                <small class="label pull-right bg-blue">1</small>
              </span>
                    </a>
              ...
              <small class="label pull-right bg-aqua">4</small>
                ...
                <li>
                    <a href="/trips">
                        <i class="fa fa-plane"></i> <span>Chuyến đi</span>
                        <span class="pull-right-container">
              <small class="label pull-right bg-aqua">4</small>
            </span>
                    </a>
                ...
                <li>
                    <a href="/routes">
                        <i class="fa fa-location-arrow"></i> <span>Tuyến đường</span>
                        <span class="pull-right-container">
              <small class="label pull-right bg-aqua">4</small>
            </span>
                    </a>
              ...
              <small class="label pull-right bg-aqua">4</small>
                ...
                <li>
                    <a href="/cars">
                        <i class="fa fa-car"></i> <span>Thông tin xe</span>
                    </a>
                </li>
                <li>
                    <a href="/settings">

	...
	<form class="form-horizontal" action="{{ route('activities.store') }}" method="post">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="time" class="form-control time" name="duration" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Calories</label>
				<div class="col-sm-10">
					<input type="number" step=1 class="form-control" name="calories" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Average Pace</label>
				<div class="col-sm-10">
					<input type="time"  class="form-control time" name="average_pace" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Average Speed</label>
				<div class="col-sm-10">
					<input type="number" step=0.01 class="form-control" name="average_speed" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Max Speed</label>
				<div class="col-sm-10">
					<input type="number" step=0.01 class="form-control" name="max_speed" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Start Time</label>
				<div class="col-sm-10">
					<input type="time" class="form-control time" name="start_time" required>
				</div>
			</div>
			<div class="form-group">

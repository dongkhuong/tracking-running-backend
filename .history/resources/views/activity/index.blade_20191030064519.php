					...
					@foreach($items as $i => $item)
						<tr>
							...
							<td class="text-center">
								<a href="{{ route('activities.show', $item->id)}}" title="Cập nhật" data-toggle="tooltip" data-original-title="Cập nhật">
									<i class="fa fa-pencil"></i>
								</a>

								<form class="link delete" action="{{ route('activities.destroy', $item->id)}}" method="post">
									@csrf
									@method('DELETE')

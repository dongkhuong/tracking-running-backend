	...
	<form class="form-horizontal" action="{{ route('activities.store') }}" method="post">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="time" class="form-control time" name="duration">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="time"  class="form-control time" name="average_pace">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Average Speed</label>
				<div class="col-sm-10">
					<input type="number" step=0.01 class="form-control" name="average_speed">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Max Speed</label>
				<div class="col-sm-10">
					<input type="number" step=0.01 class="form-control" name="max_speed">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Start Time</label>
				<div class="col-sm-10">
					<input type="time" class="form-control time" name="start_time">
				</div>
			</div>
			<div class="form-group">

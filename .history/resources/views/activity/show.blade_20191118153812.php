	...
	<form class="form-horizontal" action="{{ route('activities.update', $model->id) }}" method="post">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="time" class="form-control" name="duration time" value="{{ $model->duration }}" required>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">Calories</label>
				<div class="col-sm-10">
					<input type="number" step="=1" class="form-control" name="calories" value="{{ $model->calories}}">
				</div>
			</div>
			<div class="form-group">

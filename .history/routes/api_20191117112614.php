...
Route::group([
    ...
    Route::group([
        ...
        Route::delete('deleteJoinGroup/{group_id}','GroupController@deleteJoin')->name('groups.deleteJoin');
        Route::get('countRunners','GroupController@countRunners')->name('groups.countRunners');
        Route::post('showPostInGroup','PostController@showPostInGroup')->name('posts.showPostInGroup');
        Route::get('challenges/{group_id}', 'ChallengeController@index')->name('challenges.index');
        Route::get('showDetailChallenge/{id}', 'ChallengeController@show')->name('challenges.show');
        Route::post('challenges','ChallengeController@store')->name('challenges.store');
        Route::post('addCurrentUserIntoChallenge', 'ChallengeController@addCurrentUserIntoChallenge')->name('challenges.addCurrentUserIntoChallenge');
        Route::post('checkJoinIntoChallenge', 'ChallengeController@checkJoinIntoChallenge')->name('challenges.checkJoinIntoChallenge');
        Route::delete('deleteJoinChallenge/{challenge_id}','ChallengeController@deleteJoin')->name('challenges.deleteJoin');
        Route::get('checkSumOfChallengesOfUser','ChallengeController@checkSumOfChallenges')->name('challenges.checkSumOfChallenges');
        Route::get('getAllChallengesOfUser','ChallengeController@getAllChallengesOfUser')->name('challenges.getAllChallengesOfUser');
        Route::get('getAllGroupsOfUser','GroupController@getAllGroupsOfUser')->name('challenges.getAllGroupsOfUser');

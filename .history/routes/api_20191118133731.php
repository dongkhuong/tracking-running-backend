...
Route::group([
    ...
    Route::group([
        ...
        Route::post('getAllChallengesOfUser','ChallengeController@getAllChallengesOfUser')->name('challenges.getAllChallengesOfUser');
        Route::get('getAllGroupsOfUser','GroupController@getAllGroupsOfUser')->name('groups.getAllGroupsOfUser');

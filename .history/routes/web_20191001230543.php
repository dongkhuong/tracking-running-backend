...
*/
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::resources([
                'cars' => 'CarController',
                'car-types' => 'CarTypeController',
                'routes' => 'RouteController',
                'trips' => 'TripController',
                'hours' => 'HourController',
                'promo-codes' => 'PromoCodeController',
            ]);
            Route::get('term', 'ArticleController@showTerm')->name('term.show');
            Route::post('term', 'ArticleController@updateTerm')->name('term.update');
            Route::get('policy', 'ArticleController@showPolicy')->name('policy.show');
            Route::post('policy', 'ArticleController@updatePolicy')->name('policy.update');

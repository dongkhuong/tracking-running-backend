...
*/
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::get('getAllPosts', 'PostController@index')->name('posts.index');
            Route::get('groups','GroupController@index')->name('groups.index');
            Route::post('groups','GroupController@store')->name('groups.index');
            Route::get('groups/{id}','GroupController@show')->name('groups.index');
        });
    });

...
Route::group([
    ...
    Route::group([
        ...
        Route::post('listAllUsersYouMightKnow', 'FriendController@listAllUsersYouMightKnow');
        Route::get('getAllActivities','ActivityController@getAllActivities');
        Route::get('acceptFriend', 'FriendController@acceptFriend')->name('friends.acceptFriend');

...
class GroupController extends MainController
{
    ...
    public function countRunners(Request $request){
        ...
        if($group !=null){
            ...
            $count_runners = DB::table('group_user')->getQuery()->select('group_id',DB::raw('count(*) as total'))->groupBy('group_id')->pluck('total', 'group_id');
            // if($count > 0) {
            //     return $this->jsonOut([
            //         'business_code' => 1,
            ...
            //     return $this->jsonOut([
            //         'business_code' => 0,
            //         'message' => "This group don't have any runners!"
            //     ]);
            // }
            return $count_runners;
        } else {
            return $this->jsonOut([
                'business_code' => 2,
                'message' => 'Id group not found'
